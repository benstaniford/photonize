# Photo Organizer WiX Installer

This project creates a Windows Installer (.msi) for the Photo Organizer application.
...
```xml
<?define ProductName="Photo Organizer" ?>
<?define Manufacturer="Photo Organizer" ?>
```
